...
- **H-Fuel ½ mode** — toggle to switch between H-Fuel (at half quantity) and Mox/Promethene as fuel alternatives, reflecting actual in-game fuel consumption
...
- **ODS spreadsheet download** — export any profit calculation as an ODS file with live spreadsheet formulas (line totals, sums, profit, margin); opens in LibreOffice Calc and Excel
